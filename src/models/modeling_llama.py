...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig, layer_idx: Optional[int] = None,):
        ...
        torch.nn.init.constant_(self.gate, 0.0)
        self._init_rope()
    ...
    def forward(
        ...
        **kwargs,
        ...
        if no_memory_update and memory is None:
        ...
        if memory_output is None:
         ...
         #   combined_output = attn_output + memory_output
        ...
        return final_output, attn_weights, past_key_value, memory, norm_term
...
class LlamaDecoderLayer(nn.Module):
    def __init__(self, config: LlamaConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
        self.self_attn = LlamaAttention(  # LLAMA_ATTENTION_CLASSES[config._attn_implementation](
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Self Attention
        hidden_states, self_attn_weights, present_key_value, memory, norm_term = self.self_attn(
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        # Initialize weights and apply final processing
        self.post_init()
    def _init_gates_weights(self):
        for layer in self.model.layers:
            self._init_weights(layer.self_attn.gate)
    ...
    def prepare_inputs_for_generation(
        self, input_ids, past_key_values=None, attention_mask=None, inputs_embeds=None, memory=None,
        norm_term=None,  no_memory_update=None, **kwargs
    ):
        if past_key_values is not None:
