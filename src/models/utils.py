...
class GenerationMixin:
    ...
    def generate(
        ...
        **kwargs,
        ...
        if generation_mode == GenerationMode.GREEDY_SEARCH:
            ...
            result, memory, norm_term = self._greedy_search(
                input_ids,
                logits_processor=prepared_logits_processor,
                stopping_criteria=prepared_stopping_criteria,
                pad_token_id=generation_config.pad_token_id,
            ...
            # 13. run sample
            result, memory, norm_term = self._sample(
                input_ids,
                logits_processor=prepared_logits_processor,
        ...
        return result, memory, norm_term
    ...
    def _greedy_search(
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            ...
            model_inputs = self.prepare_inputs_for_generation(input_ids, memory=memory, norm_term=norm_term, no_memory_update=no_memory_update, **model_kwargs)
            model_inputs['memory']=memory
            model_inputs['norm_term']=norm_term
        ...
        if return_dict_in_generate:
            ...
            return input_ids, memory, norm_term
    ...
    def _sample(
        ...
        **model_kwargs,
        ...
        #     output_hidden_states=output_hidden_states,
        # )
        # memory_ = outputs.memory
        # norm_term_ = outputs.norm_term
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            ...
            next_token_logits = outputs.logits[:, -1, :]  #sequence中的最后一个词
